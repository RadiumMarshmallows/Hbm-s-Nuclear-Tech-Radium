...
public class ModItems {
	...
	public static Item ramarshmallow;
	...
	public static void initializeItem()
	{
		...
		ramarshmallow = new ItemRamarshmallow(10,true).setUnlocalizedName("ramarshmallow").setCreativeTab(MainRegistry.consumableTab).setTextureName(RefStrings.MODID + ":ramarshmallow");
	...
	private static void registerItem() {
		...
		GameRegistry.registerItem(ramarshmallow, ramarshmallow.getUnlocalizedName());
